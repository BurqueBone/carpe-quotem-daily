...
export default function LifespanVisualizer() {
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <h2 className="text-xl font-bold text-gray-900">Your Life in Months</h2>
      <p className="mt-1 text-sm text-gray-500">
        A visual of your life experienced so far.
      </p>

      {/* Date of Birth selectors */}
      <div className="mt-5">
        <p className="mb-2 text-sm font-medium text-gray-700">Date of Birth</p>

 ...
 * Provides dynamic variable replacement for email templates
 */
...
/**
 * Processes template variables in HTML content
...
/**
 * Escapes HTML in variable values to prevent XSS
...
export function buildTemplateContext(
  ...
  return {
    ...
    system: {
      ...
      unsubscribe_url: `${process.env.NODE_ENV === 'production' ? 'https' : 'http'}://your-domain.com/unsubscribe`
    }
  };
}
      ...
      <div className="relative p-4 sm:p-6 space-y-4">
        ...
        <div className="space-y-3">
            ...
            <div className="space-y-1.5 flex-1 w-full sm:w-auto">
              <div className="flex flex-col gap-1.5">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground leading-tight break-words">
                  {resource.title} <span className="text-muted-foreground font-normal text-sm">-</span>{" "}
                  <span className="text-sm text-muted-foreground font-normal">{resource.description}</span>
                </h3>
              </div>
              <div className="flex flex-wrap gap-2">
                ...
                {resource.category_name && <Badge variant="outline">{resource.category_name}</Badge>}
              </div>
            </div>
          ...
          {resource.how_resource_helps && (
            <div className="bg-warm/5 backdrop-blur-sm rounded-lg p-3 border border-warm/20">
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-1">
            ...
            <Button asChild variant="outline" size="default"></Button>
          </div>
        </div>
      </div>
    </Card>

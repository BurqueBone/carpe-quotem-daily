              ...
              {activeTab === "home" && (
                <div className="space-y-6">
                  ...
                  <div className="p-8 rounded-2xl bg-gradient-subtle shadow-card border-border/50 hover:shadow-warm transition-smooth">
                    ...
                    <a href="/life-compass" className="inline-flex items-center gap-2 bg-secondary text-black px-6 py-3 rounded-lg font-medium shadow-glow hover:shadow-xl transition-smooth">
